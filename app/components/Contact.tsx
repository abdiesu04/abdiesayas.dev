      ...
      <Container>
        <Reveal y={16}>
          <div className="flex flex-wrap items-baseline justify-between gap-x-8 gap-y-2 border-b border-paper/15 pb-5">
            ...
            <span className="label text-paper/40">Open to new work</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.16} y={16}>
          <a
            href={`mailto:${EMAIL}`}
            className="group mt-12 inline-flex flex-wrap items-center gap-x-3 border-b border-paper/30 pb-2 transition-colors hover:border-clay md:mt-16"
          >
            <span
              className="break-all font-display leading-tight transition-colors group-hover:text-clay"
        ...
        <footer className="mt-20 border-t border-paper/15 py-8 md:mt-28">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
              <span className="label text-paper/40">© 2026 Abdi Esayas</span>
              <span className="label text-paper/40">Adama, Ethiopia</span>
              ...
              {SOCIALS.map((social) => (
                <li key={social.label}>
                  <a
                    ...
                    className="label inline-flex items-center gap-1 text-paper/60 transition-colors hover:text-clay"
                  >
                    {social.label}
